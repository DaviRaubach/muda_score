...
\header {
  tagline = ##f
  breakbefore = ##t
  dedication = \markup \override #'(font-name . "STIXGeneral") \fontsize #4.5 \center-column {"but"}
  title =  "ops"
  subtitle = \markup \override #'(font-name . "STIXGeneral") \fontsize #2.5 \center-column {"d "}
